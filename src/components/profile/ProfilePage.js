...
const ProfilePage = ({auth: {user, loading}, loadUser, updateProfile}) => {
    ...
    const { firstname, middlename, lastname, student_type, job_type, specialization_type, email, phone,
       address, country, image, referrer_name, referrer_email } = formData;
                        ...
                        <div id="profile-view" className="row">
                            <div className="col-sm-12 col-md-6 col-lg-9">
                                <div id="profile-image-card" className="common-card">
                                    <Link to="/profile" className="pen picture-pen" data-toggle="modal" data-target="#myModal">
                                ...
                                <div className="common-card">
                                    <h5>Personal Info</h5>
                                    <Link to="/profile" className="pen" data-toggle="modal" data-target="#myModal">
                                            ...
                                            <form onSubmit={onSubmit}>
                                                ...
                                                <div className="modal-body">
                                                    <fieldset>
                                                        ...
                                                        <div className="form-group">
                                                            <input type="text" className="form-control" 
                                                            placeholder="Enter Middle Name" id="middlename" name="middlename"
                                                            value={middlename}
                                                            onChange={onChange} />
                                                        </div>
                                                        <div className="form-group">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div className="form-group">
                                                            <select name="student_type" className="form-control"
                                                                value={student_type}
                                                                onChange={onChange}
                                                            >
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <select name="specialization_type" className="form-control"
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <div id="modal-profile-picture" className="text-center">
                                                            <img src={showImageFlag === true ? viewImage: image} alt="profile" />
                                                        </div>
                                                    </div>
                                                    <fieldset>
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control"  
                                                                    placeholder="Enter Name" name="referrer_name"
                                                                    value={referrer_name}
                                                                    onChange={onChange} />
                                                        </div>
                                                        <div className="form-group">
                                                            ...
                                                            <input type="email" className="form-control"  
                                                                    placeholder="Enter Email" name="referrer_email"
...
export default connect(mapStateToProps, {loadUser, updateProfile})(ProfilePage); 
