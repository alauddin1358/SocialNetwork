                ...
                <div id="profile-view" className="row">
                    <div className="col-sm-12 col-md-6 col-lg-9">
                        <div id="profile-image-card" className="common-card">
                            <Link className="pen picture-pen" data-toggle="modal" data-target="#myModal">
                        ...
                        <div className="common-card">
                            <h5>Personal Info</h5>
                            <Link className="pen" data-toggle="modal" data-target="#myModal">
                        ...
                        <div className="common-card">
                            ...
                            <p><label>Student</label>Ph.D</p>
                            <p><label>Job</label>Agriculture Researcher</p>
                            <p><label>Specialization</label>{user.user_category}</p>
                        </div>
                        <div className="common-card">
                            <h5>Other Info</h5>
                            <Link className="pen" data-toggle="modal" data-target="#myModal">
