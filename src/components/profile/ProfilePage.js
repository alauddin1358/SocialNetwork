...
const ProfilePage = ({auth: {user, loading, allUsers}, loadUser, updateProfile, props}) => {
                            ...
                            <div id="profile-view" className="row">
                                <div className="col-sm-12 col-md-6 col-lg-9">
                                    <div id="profile-image-card" className="common-card">
                                        { !isSearch ? <Link to="/profile" className="pen picture-pen" data-toggle="modal" data-target="#myModal">
